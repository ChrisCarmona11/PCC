...
ic=addAnalogInputChannel (s,'Dev1',[0 1],'Voltage');
...
ic(1).TerminalConfig='Differential';
ic(1).Range=[-10 10];
ic(1).Name='Drain-Source Current';
...
ic(2).Range=[-10 10];
ic(2).Name='Drain-Source Voltage';
...
ic;
oc=addAnalogOutputChannel (s, 'Dev1',[0 1],'Voltage');
oc(1).Name='Vin';                % Naming the output channels, according
oc(2).Name='Vgs';                % to circuit schematic
oc(1).Range=[-10 10];
oc(2).Range=[-10 10];
